...
class Profile extends Component {
  ...
  profilescreen1 = () =>{
    ...
    return(
      ...
      lets start with the basics (don't worry you can change all of this later) </h2>
        <label>
          <h4>Username</h4>
            </label>
              <input
  ...
  screen2 = () => {
    ...
    return(
      <> 
        ...
        <h2 style={{color: 'white', padding: 5}} > 
          Now is the time to test your humility! </h2>
        <h2 style={{color: 'white', padding: 5}} > 
          Rank yourself 1 - 10 in the following 
          skills so that users have a better idea where your sick talents lies </h2>

          <h2 style={{color: 'white', padding: 5}} > 
          remember; humility (or not) </h2> 
            <div>
    ...
    return(
      <> 
        ...
        <h3 style={{color: 'white', padding: 5}} > 
          Finding someone to work with is great 
          - but it's not so great if you can't find time to work together </h3>

        <h3 style={{color: 'white', padding: 5}} > 
          Fill out this section to help others know when you'll be around </h3> 
          <div>
              <h4>Avalibility</h4>
              ...
              <select onChange={this.props.handleChange} name='wednesday' required>
                <option value='none' selected disabled hidden>
                  Select an Option
                </option>
                <option value='always'>Always</option>
  ...
  screen4 =() => {
    ...
    return(
      <>
       <h2 style={{color: 'white', padding: 5}} > It's all coming together</h2>
        <h1 style={{color: 'white', padding: 5}} >Tells us about yourself. </h1>

        <h3 style={{color: 'white', padding: 5}} > 
          You have name and the skills but...
          who are you? </h3>
